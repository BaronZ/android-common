...
import com.baron.android_common.R;
...
public class SpannableTextView extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        XmlResourceParser xpplinkcolor=getResources().getXml(R.color.color);
        try {
